"""Laya rates each shortlisted placement independently with one noul question.

The wording is probe-selected on the multilingual checkpoint: a uniform
three-clause Chinese statement per candidate (lines / holes / stack height)
rated against a fixed proposition. choice-style ranking was rejected by the
probes — option labels carry heavy lexical bias in this domain — while the
noul head separates the tiers cleanly.
"""
